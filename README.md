...
The current develpement version of the toolbox has been tested for [QGis 2.14](http://download.osgeo.org/qgis/).

Support for newer versions of QGis is not yet planned.
