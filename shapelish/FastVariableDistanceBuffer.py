...
class FastVariableDistanceBuffer(GeoAlgorithm):
    ...
    def defineCharacteristics(self):
        ...
        self.name, self.i18n_name = self.trAlgorithm('Fast Variable Distance Buffer')
        ...
        self.addParameter(ParameterTableField(self.DISTANCE_FIELD,
                                              self.tr('Distance field'), self.INPUT_LAYER))
