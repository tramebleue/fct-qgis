...
class UpdateFieldByExpression(GeoAlgorithm):
    ...
    def defineCharacteristics(self):
        ...
        self.name, self.i18n_name = self.trAlgorithm('Update Field By Expression')
        ...
        self.addOutput(OutputVector(self.OUTPUT, self.tr('Updated')))
